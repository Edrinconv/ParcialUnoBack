...
namespace ParcialUno.Controllers
{
    ...
    {
        private readonly ParcialCorteUnoContext _context;

        public DueñoController(ParcialCorteUnoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Dueño>> PostDueño(Dueño dueño)
        {
          if (_context.Dueños == null)
          {
              return Problem("Entity set 'ParcialCorteUnoContext.Dueños'  is null.");
          }
            ...
            return CreatedAtAction("GetDueño", new { id = dueño.IdDueño }, dueño);
        }
        ...
        {
            return (_context.Dueños?.Any(e => e.IdDueño == id)).GetValueOrDefault();
        }
    }
}
